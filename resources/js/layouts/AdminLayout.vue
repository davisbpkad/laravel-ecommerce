            ...
            <div class="relative">
              ...
              <div v-show="showUserMenu" class="absolute right-0 mt-2 w-48 bg-card border-2 border-border rounded-[5px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-50">
                <div class="py-2">
                  ...
                  <Link href="/admin/settings/profile" class="block px-4 py-2 text-card-foreground hover:bg-background transition-colors">
                    Profile Settings
                  </Link>
      ...
      <aside class="w-64 bg-card border-r-2 border-border min-h-screen sticky top-16 hidden lg:block">
        <div class="p-4">
          ...
          <div>
            ...
            <nav class="space-y-1">
              <Link href="/admin/settings/store" class="flex items-center px-3 py-2 text-card-foreground hover:bg-background rounded-[5px] transition-colors"
                    :class="{ 'bg-background border border-border': $page.url.includes('/admin/settings/store') }">
                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- <Link href="/admin/settings/profile" class="flex items-center px-3 py-2 text-card-foreground hover:bg-background rounded-[5px] transition-colors"
                    :class="{ 'bg-background border border-border': $page.url.includes('/admin/settings/profile') }">
                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main class="flex-1 p-6">
        ...
        <div v-show="showMobileMenu" class="lg:hidden mb-6 bg-card border-2 border-border rounded-[5px] p-4">
          <nav class="space-y-2">
            ...
            <Link href="/admin/settings/store" class="block py-2 text-card-foreground hover:text-primary transition-colors">
              Store Settings
            </Link>
            <Link href="/admin/settings/profile" class="block py-2 text-card-foreground hover:text-primary transition-colors">
              Profile Settings
            </Link>
          </nav>
        </div>
